...
router.get('/customers',adminController.fetchAllCustomers);
router.get('/sp',adminController.fetchAllCustomers);
router.post('/check',auth.adminAuthenticate,adminController.check);
